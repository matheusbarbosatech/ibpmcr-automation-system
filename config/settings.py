...
# Pasta de Áudio e Subpastas Unificadas da Fase 2 Mineração
if USE_GDRIVE:
...
INSIGHTS_DIR = AUDIO_DIR / "conteudos_fase2"
...
# Parâmetros da API Gemini LLM (Fase 2 Mineração - Nuvem AI Studio)
