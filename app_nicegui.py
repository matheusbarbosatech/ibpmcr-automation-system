...
# Configuração Global de Tema e Tailwind CSS
ui.dark_mode().enable()
    ...
    with ui.row().classes("w-full h-full no-wrap gap-0"):
        ...
        with ui.column().classes("w-full p-6 gap-6 bg-[#0F1117]"):
            ...
            with ui.tab_panels(tabs, value=tab_workspace).classes("w-full bg-transparent"):
                ...
                # =============================================================
                # TAB 1: STUDIO WORKSPACE (EDITOR ESTILO CAPCUT)
                # =============================================================
                with ui.tab_panel(tab_workspace).classes("w-full p-0 gap-6"):
                    ...
                    if not audios:
                        ...
                        # BARRA SUPERIOR DE CONTROLE DO CULTO ATIVO
                        ...
                        # PAINEL DE PREVIEW E TIMELINE VISUAL
                        ...
                        # STORYBOARDS DE CORTES (GRID DE CARDS ESTILO CAPCUT)
                        ui.label("🎞️ Storyboards de Cortes Minerados").classes("font-bold text-xl text-white mt-4")

                        # Carrega os cortes minerados do culto selecionado
                ...
                # =============================================================
                # TAB 3: MINERAÇÃO GEMINI FILE API
                # =============================================================
