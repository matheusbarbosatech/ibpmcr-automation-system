# ==============================================================================
# SCRIPT DE TRANSCRIÇÃO ACELERADA GPU T4 - ÚLTIMOS 2 CULTOS FALTANTES IBPM
...
# 2. Em "Input", adicione o seu Dataset com os 2 últimos áudios (da pasta ultimos_2_audios_ibpm).
...
print("=" * 70)
print("🎙️ TRANSCRIÇÃO AUTOMÁTICA DOS 2 ÚLTIMOS CULTOS FALTANTES IBPM (GPU T4)")
print("=" * 70)
...
print("\n[3/4] Procurando os 2 arquivos de áudio nos diretórios do Kaggle...")
...
if not audio_files:
    ...
    print("👉 Certifique-se de adicionar o seu Dataset com os 2 áudios no menu 'Add Input' à direita no Kaggle.")
    sys.exit(0)
...
print("• Os arquivos .txt e .json estão prontos para download no painel 'Output'!")
print("=" * 70)
